 ...
 */
  ...
  #if ANY(HAS_LCD_MENU, EXTENSIBLE_UI, MKS_TS35_V2_0, DWIN_CREALITY_LCD_ENHANCED, DWIN_CREALITY_LCD_JYERSUI) || BOTH(EMERGENCY_PARSER, HOST_PROMPT_SUPPORT)
...
// Fallback SPI Speed for SD
  ...
  #define SD_SPI_SPEED SPI_HALF_SPEED//SPI_FULL_SPEED
#endif
